...
/**
 * <h1>OSN Social Graph Display!</h1>
 * This class integrates the PeerSim and graph-stream library.  
 * It takes the  list of nodes and edges connected from the Social Gossip's {@link UserProfileDissemination} class.
 * It checks which are the new edges formed and give them green color so that it can be easily identified
 * * <p>
 * 
 * @author  Ishan Tiwari
 * @version 1.0
